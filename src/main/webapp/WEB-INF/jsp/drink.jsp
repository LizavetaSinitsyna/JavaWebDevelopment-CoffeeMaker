...
<c:set var="currentPage" value="/Controller?command=view_product&drink_id=${drinkId}"
	scope="application" />
<!DOCTYPE html>
<html>
<head>
			...
			<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
				<div class="col">
					<div class="card shadow-sm">
						<c:if test="${sessionScope.user != null && sessionScope.user.getRoleName().equals('Admin')}">
						...
						<div class="card-body">
							<p class="card-text">
								<fmt:formatNumber type="number" minFractionDigits="2" value="${drinkInfo.getPrice()}" />
					...
					<div class="card description-row">
						<p>
							<span><fmt:message key="local.product.feedback.header" /></span> <span
								class="rating float-right"> <input type="radio" name="rating" value="5" id="5">
								<label for="5">☆</label> <input type="radio" name="rating" value="4" id="4"> <label
