...
<header
	...
	<a href="/CoffeeMachine/index.jsp"
	...
	<ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
		...
		<li><form action="Controller">
				...
				<input id="menu" type="submit"
					class="btn nav-link link-dark  text-uppercase" name="menu"
					value="<fmt:message
	...
	<ul class="nav col-12 col-md-auto mb-2 mb-md-0 text-end">
		<li id="basket-area"><a href="#" class="basket icon-image"></a><a
		...
		<c:choose>
			<c:when test="${user != null}">
				<li class="header-link-border header-link-border-stat">
					<form action="Controller">
						...
						<input id="log_out" type="submit" class="btn" name="log_out"
							value="<fmt:message
							key="local.header.log_out.name"/>" />
					</form>
				</li>
				<li><button id="log_out" type="submit" class="btn"
						name="log_out" style="text-align: -webkit-center;">
						<img src="/CoffeeMachine/images/user_icon.png"
							style="display: block;">
			...
			<c:otherwise>
				<li class="header-link-border header-link-border-stat"><a
					href="/CoffeeMachine/login" class="nav-link link-dark"><fmt:message
							key="local.header.login.name" /></a></li>
				<li class="header-link-border header-link-border-stat"><a
					href="/CoffeeMachine/registration" class="nav-link link-dark"><fmt:message
