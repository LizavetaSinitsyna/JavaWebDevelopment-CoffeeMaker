...
<head>
<meta charset="UTF-8">
<title><fmt:message key="local.pay.successful_payment" /></title>
<link
...
<body>
	...
	<p>
		<fmt:message key="local.pay.successful_payment" />
	</p>
	<img alt="Preparing coffee..." src="/CoffeeMachine/images/prepare_coffee.gif">
	<%@include file="partial_pages/footer.jsp"%>
	<script src="/CoffeeMachine/js/bootstrap.bundle.min.js"></script>
	<script src="/CoffeeMachine/js/successPayment.js"></script>
